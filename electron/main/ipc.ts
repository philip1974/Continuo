...
import { timed } from './lib/reload-breadcrumb';
...
export function registerIpc() {
  ...
  safeHandle(
    'explorer:read',
    NoInput,
    () => timed('explorer:read', () => loadExplorer(explorerFile)),
    trusted,
  );
  safeHandle(
    'explorer:write',
  ...
  // 启动/刷新黑屏诊断(issue #33):breadcrumb + openLogsDir + relaunch
