...
export const ko: Record<TranslationKey, string> = {
  ...
  'settings.general.language.save_failed': '언어 변경 실패',
  ...
  'errors.MARKETPLACE_INDEX_INVALID': '원격 인덱스가 올바른 배열이 아닙니다',
  'errors.MARKETPLACE_REVIEWS_NO_TOKEN': '메인 프로세스에 GitHub 토큰이 설정되지 않았습니다',
  ...
  'errors.NOT_SUPPORTED': '지원되지 않는 작업입니다',
  'errors.NO_ACTIVE_TAB': '활성 탭이 없습니다',
  'errors.TAB_NOT_FOUND': '탭을 찾을 수 없습니다',
  'errors.UNSAVED_DRAFT': '경로가 없는 제목 없는 초안은 저장할 수 없습니다',
  'errors.NO_DEFAULT_EXPORT': '플러그인에 default export가 없습니다',
  'errors.NOT_PLUGIN_CLASS': '플러그인 default export가 Plugin 하위 클래스가 아닙니다',
  'errors.PAYLOAD_TOO_LARGE': '페이로드가 너무 큽니다',
  'errors.POPOUT_NOT_IMPLEMENTED': '팝아웃이 구현되지 않았습니다',
  'errors.RM_FAILED': '삭제 실패',
  'errors.TERMINAL_CREATE_CANCELLED': '터미널 생성이 취소되었습니다',
  ...
  'errors.TERMINAL_WRITE_FAILED': '터미널에 쓰기 실패',
  'errors.TERMINAL_SESSION_DUPLICATE': '터미널 세션 중복',
  'errors.TERMINAL_SESSION_NOT_FOUND': '터미널 세션을 찾을 수 없습니다',
  'errors.TOO_MANY_STREAMS': '활성 스트림이 너무 많습니다',
  'errors.TOO_MANY_TERMINALS': '터미널 세션이 너무 많습니다',
  ...
  'errors.FS_FILE_TOO_LARGE': '파일이 너무 커서 열 수 없습니다',
  'errors.FS_DIR_TOO_LARGE': '디렉터리 항목이 너무 많습니다',
  ...
  'commands.terminal.search.title': '터미널에서 찾기',
  ...
  'commands.explorer.category': '탐색기',

  // panels.*
  'panels.terminal.title': '터미널',
  'panels.editor.title': '편집기',
  'panels.output.title': '출력',
  'panels.output.ready': 'Continuo 준비됨',
  'panels.output.layout_restored': '도크 레이아웃 복원됨',
  'panels.settings.title': '설정',
  'panels.debug.title': '디버그',
  'panels.debug.tab.stack': '호출 스택',
  'panels.debug.tab.variables': '변수',
  'panels.debug.tab.breakpoints': '중단점',
  'panels.debug.views_aria': '디버그 보기',
  'panels.debug.empty_session': '디버그 세션 없음',
  'panels.debug.empty_stack': '스택 프레임 없음',
  'panels.debug.empty_variables': '변수 없음',
  'panels.debug.empty_breakpoints': '중단점 없음',
  'panels.debug.paused': '일시 중지됨',
  'panels.debug.running': '실행 중',
  'panels.debug.unknown': '알 수 없음',
  'panels.debug.scope_ref': '참조 {ref}',
  'panels.debug.load_scope': '{scope} 로드',
  'panels.debug.breakpoint.verified': '확인됨',
  'panels.debug.breakpoint.pending': '대기 중',
  ...
  'panels.explorer.tree_aria': '파일 트리',
  'panels.explorer.copy_path_failed': '클립보드에 경로 복사 실패',
  ...
  'panels.explorer.rename_input_aria': '{name} 이름 바꾸기',
  ...
  'keybindings.modal.conflict_title': '이 조합은 다른 명령에 이미 바인딩되어 있습니다',
  ...
  'panels.explorer.menu.open_recent_item_aria': '최근 항목 열기: {path}',
  ...
  'panels.terminal.search.options_group': '검색 옵션',
  ...
  'panels.editor.unsaved_indicator': '저장되지 않은 변경 사항',
  'panels.editor.placeholder.start_writing': '작성을 시작하세요…',
  'panels.editor.mode.edit': '편집',
  'panels.editor.mode.source': '소스',
  'panels.editor.mode.preview': '미리보기',
  'panels.editor.mode_group': '편집기 모드',
  ...
  'permissions.agent.respond_failed': '권한 결정 전송에 실패했습니다. 다시 시도하세요.',
  'permissions.fs_scope.respond_failed': '파일 접근 결정 전송에 실패했습니다. 다시 시도하세요.',
  ...
  'errors.terminal.remove_failed': '터미널 닫기 실패: {code}',
  'errors.terminal.sessions_restore_failed': '터미널 세션 복원 실패',
  'errors.dock.layout_restore_failed': '패널 레이아웃 복원 실패; 기본값으로 초기화됨',
  'errors.dock.layout_save_failed': '패널 레이아웃 저장 실패',
  ...
  'plugins_tab.warning.partial_grant': '부분 승인 — 허용: {granted}; 미허용: {denied}',
  ...
  'keybindings.edit_hotkey_for_aria': '{command} 단축키 편집',
  'keybindings.reset_default_for_aria': '{command} 단축키를 기본값으로 초기화',
  ...
  'shell.dock.popout_failed': '새 창에서 패널 열기 실패',
  'shell.tab.exit_zoom': '확대 종료',
  'shell.tab.close': '{title} 닫기',
  'shell.tab.editor_tablist': '편집기 탭',
  'shell.tab.dock_tablist': '패널 탭',
  ...
  'marketplace.loading': '플러그인 마켓 로딩 중…',
  ...
  'marketplace.install_failed_code': '설치 실패 [{code}] {message}',
  ...
  'marketplace.reviews.open_in_github_by': '{author}님의 리뷰를 GitHub에서 열기',
  ...
  'marketplace.reviews.write_first': 'GitHub에서 첫 리뷰 작성',
  'marketplace.reviews.write_review': '리뷰 작성',
  ...
  'permissions.editor.save_failed': '권한 저장에 실패했습니다. 다시 시도하세요.',
  'permissions.editor.load_failed': '현재 권한을 불러오지 못했습니다. 다시 열거나 시도하세요.',

  // quick_open.*
  'quick_open.placeholder': '파일 이름 / 경로 조각 검색 ({shortcut}로 명령 팔레트 전환)…',
